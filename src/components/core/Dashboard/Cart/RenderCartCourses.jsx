          ...
          cart.map((course,index) => (
            ...
            >
                <div className='flex flex-1 flex-col gap-4 xl:flex-row'>
                    ...
                    className='lg:h-[148px] md:h-[148px] h-[130px] lg:w-[220px] md:w-[220px] w-[200px] rounded-lg object-cover'
                    />
                    <div className='flex flex-col space-y-1'>
                        ...
                        {/* rating ka hard code kr rhe hai but hame getAverrage rating ka use krke krna hai */}
