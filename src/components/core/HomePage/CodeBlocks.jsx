...
export const CodeBlocks = ({ position ,heading, subheading ,ctabtn1,ctabtn2, codeblock, backgroundGradient,
      codeColor}) => {
  ...
  return (
    <div className= {`flex  ${position} flex-col my-20  justify-between gap-10  `}>
      ...
      {/* section 1 */}
      <div className='lg:w-[50%] w-[100%] flex sm:items-center sm:justify-between flex-col gap-8'>
       {heading}
       <div className='text-richblack-300 font-bold '>
        {subheading}
       </div>
       <div className='flex flex-row md:items-center sm:items-center gap-7 mt-7'>
